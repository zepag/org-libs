...
/**
 * This handler returns a random Short value.<br>
 * It handles the Short type and the primitive short type.
 * 
 * @author pagregoire
 */
public class ShortPropertyTypeHandler extends AbstractPropertyTypeHandler {
    
    private static Set<PropertyTypeDefinition> handledTypes;
    static {
        handledTypes = new HashSet<PropertyTypeDefinition>();
        handledTypes.add(new PropertyTypeDefinition(Short.class));
        handledTypes.add(new PropertyTypeDefinition(short.class));
    }
     ...
     */
    public ShortPropertyTypeHandler() {
        super(handledTypes);
    }
